...
select name from students 
where created_on='2021-07-12 00:00:00'or created_on='2021-05-19 00:00:00' or created_on='2021-03-26 00:00:00';
--вариант 2
select name from students 
where created_on in ('2021-07-12 00:00:00','2021-05-19 00:00:00','2021-03-26 00:00:00');
...
select id,name,email,password,created_on from students order by created_on asc

--32. Вывести id пользователя, имя, дату создания пользователя. Отсортировать по порядку убывания даты добавления пользоватлеля.
select id,name,email,password,created_on from students order by created_on DESC
